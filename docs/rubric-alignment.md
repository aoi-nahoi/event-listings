...
| User input | Search/filter, event creation, bookmark creation |
| Rich interface/HTMX | HTMX partial results and bookmark updates |
| Tests/specs/docs | Tests, README, docs, presentation notes |
| Project deployment | `render.yaml`, WhiteNoise, Gunicorn, health check |
| Presentation performance | Demo and code explanation scripts |
